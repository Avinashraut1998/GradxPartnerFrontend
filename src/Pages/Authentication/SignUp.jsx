...
import LogoDark from "../../images/logo/svglogo.svg";
                  ...
                  <div className="relative">
                    <input
                      ...
                      className={`w-full rounded-lg border ${
                        formErrors.firstname ? "border-error" : "border-stroke"
                      } bg-transparent py-4 pl-6 pr-10 outline-none focus:border-danger focus-visible:shadow-none dark:border-form-strokedark dark:bg-form-input dark:focus:border-primary`}
                    />

                    {formErrors.firstname && (
                      <span className="absolute right-4 top-4 text-error">
                        {formErrors.firstname}
                      </span>
                    )}
                  </div>
                ...
                <div className="mb-4">
                  ...
                  <div className="relative">
                    <input
                      ...
                      onChange={handleInputChange}
                      className={`w-full rounded-lg border ${
                        formErrors.lastname ? "border-error" : "border-stroke"
                      } bg-transparent py-4 pl-6 pr-10 outline-none focus:border-danger focus-visible:shadow-none dark:border-form-strokedark dark:bg-form-input dark:focus:border-primary`}
                    />
                ...
                <div className="mb-4">
                  ...
                  <div className="relative">
                    <input
                      ...
                      onChange={handleInputChange}
                      className={`w-full rounded-lg border ${
                        formErrors.email ? "border-error" : "border-stroke"
                      } bg-transparent py-4 pl-6 pr-10 outline-none focus:border-danger focus-visible:shadow-none dark:border-form-strokedark dark:bg-form-input dark:focus:border-primary`}
                    />
                ...
                <div className="mb-4">
                  ...
                  <div className="relative">
                    <input
                      ...
                      onChange={handleInputChange}
                      className={`w-full rounded-lg border ${
                        formErrors.password ? "border-error" : "border-stroke"
